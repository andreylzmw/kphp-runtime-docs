# Как 2 байта переслать: контрибьютим в KPHP

## Что такое KPHP
![kphp-1](https://github.com/andreylzmw/kphp-runtime-docs/assets/110744283/eb646a51-00c7-42f8-bac0-1865afb2b980)


KPHP - компилятор для PHP. Он конвертирует PHP код в код на C++, компиляруя который, ускоряет производительность в десятки раз. Это open-source проект, созданный Вконтакте. Благодаря ему собирается огромный монолит Вконтакте на 9 миллионов строк PHP кода в обычный бинарник, запуская который вы локально поднимаете полноценный Вконтакте.
